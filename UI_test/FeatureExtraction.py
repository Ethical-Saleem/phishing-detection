...
class FeatureExtraction:
    ...
    def havingIP(self,url):
        """If the domain of the url/website has IP then it is a phishing URL otherwise legitimate"""
...
def getAttributess(url):
    ...
    redirection_symbol = feature_ext.redirection(url)
